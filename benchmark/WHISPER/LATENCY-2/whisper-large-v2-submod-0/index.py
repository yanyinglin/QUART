...
async def call_next_function(input_data):
    ...
    try:
        async with aiohttp.ClientSession() as session:
            ...
            async with session.post("http://172.169.8.253:31112/function/whisper-large-v2-submod-1-latency-2.cdgp#"+str(uid), json=input_data, timeout=timeout) as response:
