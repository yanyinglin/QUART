...
async def call_next_function(input_data):
    ...
    try:
        async with aiohttp.ClientSession() as session:
            ...
            async with session.post("http://172.169.8.253:31112/function/llama2-70b-wholemod-1-llama2-70b-whole.dasheng#"+str(uid), json=input_data, timeout=timeout) as response:
